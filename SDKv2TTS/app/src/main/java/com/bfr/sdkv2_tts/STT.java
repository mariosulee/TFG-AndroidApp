...
public class STT extends BuddyActivity {
    String TAG = "SDK_STT";
    private final STT mainActivity = this;
    ...
    public void onSDKReady() {
        ...
        Locale[] languageItems = new Locale[]{Locale.FRENCH, Locale.ENGLISH, new Locale("es", "ES")};
    ...
    private void createSTTTask(int sttEnginePosition) {
        ...
        switch (sttEngine) {
            case googleSttEngineLabel:
                // Aseguramos que Google STT use español si el usuario lo selecciona
                if (locale.equals(new Locale("es", "ES"))) {
                    sttTask = BuddySDK.Speech.createGoogleSTTTask(new Locale("es", "ES"));
                } else {
